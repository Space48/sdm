...
export interface paths {
  ...
  "/catalog/products/{product_id}/images": {
     ...
     * - Supported image file types are BMP, GIF, JPEG, PNG, WBMP, and XBM.
     */
  ...
  getProducts: {
    parameters: {
      query: {
        ...
        /** Filter items by brand_id. */
        brand_id?: unknown;
        /** Filter items by `date_modified`. For example, `/v3/catalog/products?date_modified:min=2018-06-15` gets all products modified after `2018-06-15` */
