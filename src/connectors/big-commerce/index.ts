              ...
              values: {
                endpoints: {
                  list: endpoint.fn(
                    ...
                    (bcClient, uri, query: Query | undefined, [attributeId]) =>
                      bcClient.list<object>(uri, {
                        ...query,
                        ...
                        image: {
                          endpoints: {
                            create: endpoint.create(
                              "v3/catalog/products/{id}/modifiers/{id}/values/{id}/image",
                            ),
                          },
                          documents: {
                            endpoints: {
                              delete: endpoint.del(
                                "v3/catalog/products/{id}/modifiers/{id}/values/{id}/image/{id}",
                              ),
                            },
                          },
                        },
