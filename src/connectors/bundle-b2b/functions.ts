...
export namespace endpoint {
  ...
  export function fn<I = any, O = any>(
    uriPattern: string,
    _fn: (client: BundleB2b, uri: string, data: I, path: ReadonlyArray<DocId>) => Promise<O> | AsyncIterable<O>
  ...
  export const list = (uriPattern: string) =>
    fn(uriPattern, (bB2bClient, uri, query: Query|undefined) => bB2bClient.list<object>(uri, query));
