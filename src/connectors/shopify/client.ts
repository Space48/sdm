...
export class Scope {
  ...
  async * flatMap(resourceKey: string, endpointKey: string, ids: any[], input?: any): AsyncIterable<any> {
  ...
  async * listIds(resourceKey: string, endpointKey: string, ids: any[], input?: any): AsyncIterable<number> {
