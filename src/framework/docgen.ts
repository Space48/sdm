...
export namespace Shell {
  ...
  function describeCommandsOnCli(
...
`;
  ...
  function describeResourceUsage(
    nestingLevel: number,
    ...
    const endpointUsage = headersSorted
      .map(header => describeEndpointUsage(nestingLevel + 1, header))
      .join("\n\n");
...
`;
  ...
  function describeEndpointUsage(
    nestingLevel: number,
