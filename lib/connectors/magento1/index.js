...
exports.magento1 = framework_1.connector({
    ...
    resources: {
        ...
        customers: mergeResources(functions_1.Rest.crud('customers', ['addresses']), {
            ...
            endpoints: {
                listSoap: ({ soap }) => async function* ({ input: filters }) {
                    yield* await soap.execute('customerCustomerList', { filters: functions_1.Soap.filters(filters) });
                },
            },
        }),
        orders: mergeResources(functions_1.Rest.read('orders', ['addresses', 'comments', 'items']), {
            endpoints: {
                listSoap: ({ soap }) => async function* ({ input: filters }) {
                    yield* await soap.execute('salesOrderList', { filters: functions_1.Soap.filters(filters) });
                },
            },
        }),
