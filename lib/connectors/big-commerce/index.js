...
exports.bigCommerce = framework_1.connector({
    ...
    resources: {
            ...
            resources: {
                ...
                attributes: mergeResources(functions_1.batch.crud('v3/customers/attributes'), {
                    ...
                    resources: {
                        values: {
                            endpoints: {
                                delete: functions_1.batch.del('v3/customers/attribute-values'),
                                list: functions_1.endpoint.list('v3/customers/attribute-values'),
                                upsert: functions_1.batch.update('v3/customers/attribute-values'),
                            },
                            documents: {
                                endpoints: {
        ...
        products: mergeResources(functions_1.endpoint.crud('v3/catalog/products'), {
            endpoints: {
                update: functions_1.batch.update('v3/catalog/products'),
            },
            resources: {
                variants: {
                    endpoints: {
                        list: functions_1.endpoint.list('v3/catalog/variants'),
                        update: functions_1.batch.update('v3/catalog/variants'),
                    },
                }
            },
            documents: {
