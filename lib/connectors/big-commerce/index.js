...
exports.bigCommerce = framework_1.connector({
    ...
    resources: {
        blog: {
            resources: {
                posts: functions_1.endpoint.crud('v2/blog/post'),
                tags: functions_1.endpoint.crud('v2/blog/tag'),
            },
        },
                        ...
                        values: {
                            ...
                            documents: {
                                endpoints: {
                                    ...
                                    set: functions_1.batch.updateOne('v3/customers/attribute-values'),
                                },
                            },
                        },
                    },
        ...
        products: mergeResources(functions_1.endpoint.crud('v3/catalog/products'), {
            endpoints: {
                update: functions_1.batch.updateOne('v3/catalog/products'),
            },
            resources: {
                variants: {
                    endpoints: {
                        list: functions_1.endpoint.list('v3/catalog/variants'),
                        update: functions_1.batch.updateOne('v3/catalog/variants'),
                    },
                }
            },
            documents: {
                resources: {
                    ...
                    variants: mergeResources(functions_1.endpoint.crud('v3/catalog/products/{id}/variants'), {
                        documents: {
                            resources: {
                                variants: functions_1.endpoint.crud('v3/catalog/products/{id}/variants/{id}/metafields'),
                            },
                        },
                    }),
