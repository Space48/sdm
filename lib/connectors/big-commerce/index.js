import BigCommerce, { configSchema } from "./client";
import { connector, resourceMerger } from "../../framework";
import { batch, endpoint, listIds } from "./functions";
...
export const bigCommerce = connector({
    ...
    resources: {
        ...
        brands: mergeResources(endpoint.crud("v3/catalog/brands"), {
            documents: {
                resources: {
                    image: {
                        endpoints: {
        ...
        categories: mergeResources(endpoint.crud("v3/catalog/categories"), {
            resources: {
                tree: {
                    endpoints: {
        ...
        customers: mergeResources(batch.crud("v3/customers"), {
            resources: {
                addresses: batch.crud("v3/customers/addresses"),
                attributes: mergeResources(batch.crud("v3/customers/attributes"), {
                    documents: {
                        resources: {
                            values: {
                                endpoints: {
                                    list: endpoint.fn("v3/customers/attribute-values", (bcClient, uri, query, [attributeId]) => bcClient.list(uri, {
                                        ...query,
        ...
        orders: mergeResources(endpoint.crud("v2/orders"), {
            documents: {
                resources: {
                    refunds: {
                        endpoints: {
        ...
        priceLists: mergeResources(endpoint.crud("v3/pricelists"), {
            resources: {
                assignments: {
                    endpoints: {
        ...
        products: mergeResources(endpoint.crud("v3/catalog/products"), {
            endpoints: {
            ...
            documents: {
                resources: {
                    ...
                    modifiers: mergeResources(endpoint.crud("v3/catalog/products/{id}/modifiers"), {
                        documents: {
                            resources: {
                                values: mergeResources(endpoint.crud("v3/catalog/products/{id}/modifiers/{id}/values"), {
                                    documents: {
                                        resources: {
                                            image: {
                                                endpoints: {
                    ...
                    options: mergeResources(endpoint.crud("v3/catalog/products/{id}/options"), {
                        documents: {
                            resources: {
                    ...
                    variants: mergeResources(endpoint.crud("v3/catalog/products/{id}/variants"), {
                        documents: {
                            resources: {
        ...
        wishlists: mergeResources(endpoint.crud("v3/wishlists"), {
            documents: {
                resources: {
                    items: {
                        endpoints: {
