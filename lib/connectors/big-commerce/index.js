    ...
    resources: {
            ...
            documents: {
                ...
                resources: {
                    items: {
                        ...
                        documents: {
                            endpoints: {
                                delete: functions_1.endpoint.del("v3/carts/{id}/items/{id}"),
                                update: functions_1.endpoint.update("v3/carts/{id}/items/{id}"),
                            },
                        },
                    },
                },
        ...
        customers: mergeResources(functions_1.batch.crud("v3/customers"), {
            resources: {
                ...
                customerGroups: {
                    endpoints: {
                        list: functions_1.endpoint.list("v2/customer_groups"),
                        create: functions_1.endpoint.create("v2/customer_groups"),
                    },
                },
                subscribers: functions_1.endpoint.crud("v3/customers/subscribers"),
            },
        }),
        ...
        orders: mergeResources(functions_1.endpoint.crud("v2/orders"), {
            documents: {
                resources: {
                    ...
                    metafields: {
                        endpoints: {
                            list: functions_1.endpoint.list("v3/orders/{id}/metafields"),
                            create: functions_1.endpoint.create("v3/orders/{id}/metafields"),
                        },
                        documents: {
                            endpoints: {
                                get: functions_1.endpoint.get("v3/orders/{id}/metafields/{id}"),
                                delete: functions_1.endpoint.del("v3/orders/{id}/metafields/{id}"),
                                update: functions_1.endpoint.update("v3/orders/{id}/metafields/{id}"),
                            },
                        },
                    },
                },
        ...
        promotions: mergeResources(functions_1.endpoint.crud("v3/promotions"), {
            documents: {
                resources: {
                    codes: {
                        endpoints: {
                            create: functions_1.endpoint.create("v3/promotions/{id}/codes"),
                            delete: functions_1.batch.deleteMany("v3/promotions/{id}/codes"),
                            list: functions_1.endpoint.list("v3/promotions/{id}/codes"),
                        },
                        documents: {
                            endpoints: {
                                delete: functions_1.endpoint.del("v3/promotions/{id}/codes/{code_id}"),
                            },
                        },
                    },
                },
        ...
        widgets: {
            endpoints: {
                list: functions_1.endpoint.list("v3/content/widgets"),
                create: functions_1.endpoint.create("v3/content/widgets"),
            },
            documents: {
                endpoints: {
                    get: functions_1.endpoint.get("v3/content/widgets/{id}"),
                    delete: functions_1.endpoint.del("v3/content/widgets/{id}"),
                    update: functions_1.endpoint.update("v3/content/widgets/{id}"),
                },
            },
            resources: {
                regions: {
                    endpoints: {
                        list: functions_1.endpoint.list("v3/content/regions"),
                    },
                },
                templates: {
                    endpoints: {
                        list: functions_1.endpoint.list("v3/content/widget-templates"),
                        create: functions_1.endpoint.create("v3/content/widget-templates"),
                    },
                    documents: {
                        endpoints: {
                            get: functions_1.endpoint.get("v3/content/widget-templates/{id}"),
                            delete: functions_1.endpoint.del("v3/content/widget-templates/{id}"),
                            update: functions_1.endpoint.update("v3/content/widget-templates/{id}"),
                        },
                    },
                },
                placements: {
                    endpoints: {
                        list: functions_1.endpoint.list("v3/content/placements"),
                        create: functions_1.endpoint.create("v3/content/placements"),
                    },
                    documents: {
                        endpoints: {
                            get: functions_1.endpoint.get("v3/content/placements/{id}"),
                            delete: functions_1.endpoint.del("v3/content/placements/{id}"),
                            update: functions_1.endpoint.update("v3/content/placements/{id}"),
                        },
                    },
                },
            },
        },
        wishlists: mergeResources(functions_1.endpoint.crud("v3/wishlists"), {
            documents: {
                resources: {
                    items: {
                        endpoints: {
                            create: functions_1.endpoint.create("v3/wishlists/{id}/items"),
                        },
                        documents: {
                            endpoints: {
                                delete: functions_1.endpoint.del("v3/wishlists/{id}/items/{id}"),
                            },
                        },
                    },
                },
