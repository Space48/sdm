...
(function (batch) {
    function crud(uriPattern, idField = 'id') {
        return {
            endpoints: {
                ...
                delete: batch.createOne(uriPattern),
                list: endpoint.list(uriPattern),
                update: batch.update(uriPattern),
            },
            documents: {
                idField,
                listIds: listIds(uriPattern, idField),
    ...
    batch.crud = crud;
    batch.createOne = (uriPattern) => endpoint.fn(uriPattern, (bcClient, uri, data) => bcClient.post(uri, [data]));
    ...
    batch.del = (uriPattern) => endpoint.fn(uriPattern, (bcClient, uri, data) => bcClient.delete(uri, data));
    ...
    batch.update = (uriPattern) => endpoint.fn(uriPattern, (bcClient, uri, data) => bcClient.put(uri, data));
