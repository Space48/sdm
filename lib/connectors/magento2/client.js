...
class Magento2 {
    ...
    async fetch(options) {
        const async = (options === null || options === void 0 ? void 0 : options.fetchAsynchronously) ? '/async' : undefined;
        const doFetch = (config) => {
            return node_fetch_1.default(`${config.baseUrl}/rest${async}/V1/${options.uri}`, {
                headers: {
