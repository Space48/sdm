...
(function (endpoint) {
    ...
    endpoint.createAsync = (uriPattern) => fn(uriPattern, (m2Client, uri, data) => m2Client.post(uri, data, true));
    ...
    endpoint.updateAsync = (uriPattern) => fn(uriPattern, (m2Client, uri, data) => m2Client.put(uri, data, true));
    endpoint.updateAsyncTEST = (uriPattern) => fn(uriPattern, (m2Client, uri, data) => m2Client.put(uri, data, true));
