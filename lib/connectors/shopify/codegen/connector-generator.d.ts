...
declare type InferResourceDefn<Res extends InferredResource, Config, Depth extends string> = ResourceDefinition<client.Scope, InferEndpointDefnMap<Res, Prop<Config, "endpoints", undefined>, "resource", Depth>, Record<string, never>, InferDocumentDefn<Res, Config, t.Number.Plus<"1", Depth>>>;
...
declare type PermitUndefinedIfPermitsEmptyObject<T> = Record<string, never> extends T ? T | undefined : T;
