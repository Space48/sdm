...
(function (endpoint) {
    ...
    endpoint.fn = fn;
    endpoint.create = (uriPattern) => fn(uriPattern, (bB2bClient, uri, data) => bB2bClient.post(uri, data));
    endpoint.del = (uriPattern) => fn(uriPattern, (bB2bClient, uri, data) => bB2bClient.delete(uri, data));
    endpoint.get = (uriPattern) => fn(uriPattern, (bB2bClient, uri, data) => bB2bClient.get(uri, data));
    endpoint.list = (uriPattern) => fn(uriPattern, (bB2bClient, uri, query) => bB2bClient.list(uri, query));
    endpoint.update = (uriPattern) => fn(uriPattern, (bB2bClient, uri, data) => bB2bClient.put(uri, data));
